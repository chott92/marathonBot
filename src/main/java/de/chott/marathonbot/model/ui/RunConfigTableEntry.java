...
public class RunConfigTableEntry {
	...
	public RunConfigTableEntry(RunConfig config) {
		this(config.getGame(), config.getRunnerName(), config.getWrTime(), config.getRunnerPB(),
				config.getWrHolderName(), config.getCategory(), config.getSpeedrunComLink());
